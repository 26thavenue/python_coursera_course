...
def calculate_subtotal(order):
    ...
    ### WRITE SOLUTION HERE
    print(' The sum of the prices of the items in the order is :')
    items = []
...
def summarize_order(order):
    ...
    # Printing out the name of ordered items
    names = []
    names = [names['name'] for names in order]
    return names, total
...
def main():
    ...
    print ('The order was ' + str(items))
    print("Total order costs " + str(subtotal))
